...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY FXYYCXX CODE              [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "fxyycxx" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Token Salah! Beli Kode Token Di FxyyXcode${NC}"
    echo -e "${YELLOW}TELEGRAM : @FxyyCxx${NC}"
    echo -e "${YELLOW}IG : @CdeFxyy{NC}"
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/fxyy2009/Pterodactyl-Theme-Autoinstaller/raw/main/stellar.zip")        
        break
        ;;
      2)
        THEME_URL=$(echo -e "https://github.com/fxyy2009/Pterodactyl-Theme-Autoinstaller/raw/main/billing.zip")
        break
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/fxyy2009/Pterodactyl-Theme-Autoinstaller/raw/main/enigma.zip")
        break
        ;; 
      x)
        return
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/fxyy2009/installer-theme/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/stellar.zip https://github.com/fxyy2009/Pterodactyl-Theme-Autoinstaller/raw/main/stellar.zip
...
while true; do
  ...
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : Fxyycxx      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : FxyyCxx      ${NC}"
